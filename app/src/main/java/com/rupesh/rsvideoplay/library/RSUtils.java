...
public class RSUtils {
    ...
    public static void saveProgress(Context context, String url, int progress) {
        if (!RSVideoPlayer.SAVE_PROGRESS) return;
        SharedPreferences spn = context.getSharedPreferences("RSVD_PROGRESS", Context.MODE_PRIVATE);
    ...
    public static int getSavedProgress(Context context, String url) {
        if (!RSVideoPlayer.SAVE_PROGRESS) return 0;
        SharedPreferences spn;
        spn = context.getSharedPreferences("RSVD_PROGRESS", Context.MODE_PRIVATE);
